  ...
  return (
    <header className='fixed w-full shadow bg-white backdrop-blur-lg py-4 flex items-center justify-between z-20 pl-79 pr-5'>
      ...
      <span className='flex items-center space-x-4'>
        ...
        <button className='p-2.5 hidden lg:block bg-primary/20 rounded-full cursor-pointer hover:bg-primary/70 text-primary-500 hover:text-white group transform will-change-transform transition-300'>
